...
//pli11
__device__ __forceinline__ uint64_t combine_result(const uint32_t x, const uint32_t y)
{
        uint64_t result;
        asm (
                "{\n\t"
...
__device__ __forceinline__ uint32_t split_result(const uint64_t x)
{
        uint32_t result;
        asm (
                "{\n\t"
...
/*
#ifdef __CUDA_ARCH__
__device__ __forceinline__ uint32_t fnv1a(const uint32_t h,const uint32_t d)
{
        uint32_t result;
        asm (
                "{\n\t"
...
//#define fnv1a(h, d) (h = split_result(((h) ^ (d)) *(0x01000193)))
//#endif
...
//	return __byte_perm(x, x, 0x0123);
        ...
        asm("{\n\t"
                ...
                "shr.b32 t3, %1, 8;\n\t"
                "shr.b32 t4, %1, 24;\n\t"
                "and.b32 t1,  t1, 0xff000000;\n\t"
                "and.b32 t2,  t2, 0x00ff0000;\n\t"
                "and.b32 t3,  t3, 0x0000ff00;\n\t"
                "and.b32 t4,  t4, 0x000000ff;\n\t"
                " or.b32 %0,  t1, t2;\n\t"
                " or.b32 %0,  %0, t3;\n\t"
                " or.b32 %0,  %0, t4;\n\t"
        "}\n"
...
// 64-bit ROTATE RIGHT
#if __CUDA_ARCH__ >= 120 && USE_ROT_ASM_OPT == 2
__device__ __forceinline__
