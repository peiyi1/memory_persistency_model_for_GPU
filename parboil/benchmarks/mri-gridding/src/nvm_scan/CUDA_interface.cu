...
/*The CUDPP library features highly optimizes implementations for radix sort
  ...
  //st_binning.print_avg_usec("binning", grid1);
  //st_reorder.print_avg_usec("reorder", grid1);
  //st_grid.print_avg_usec("gridding", grid2);
