...
void sort (int numElems, unsigned int max_value, unsigned int* &dkeys, unsigned int* &dvalues){
  ...
  for (int i=0; i<iterations; i++){
    ...
    if (nvm_opt == 'a')
      ...
      splitSort_nvmb<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'g')
      splitSort_nvmg<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'i')
      splitSort_nvmi<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'd')
      splitSort_nvmd<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'o')
      splitSort_nvmo<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'q')
      splitSort_nvmq<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'u')
      splitSort_nvmu<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == 'w')
      splitSort_nvmw<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '1')
      splitSort_nvm1<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '2')
      splitSort_nvm2<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '3')
      splitSort_nvm3<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '4')
      splitSort_nvm4<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '5')
      splitSort_nvm5<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else if (nvm_opt == '6')
      splitSort_nvm6<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    else 
      splitSort<<<grid,block>>>(numElems, i, dkeys, dvalues, dhisto);
    st_ssort.lap_end();
    ...
    if (nvm_opt == 'a')
      ...
      splitRearrange_nvmb<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'g')
      splitRearrange_nvmg<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'i')
      splitRearrange_nvmi<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'd')
      splitRearrange_nvmd<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'o')
      splitRearrange_nvmo<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'q')
      splitRearrange_nvmq<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'u')
      splitRearrange_nvmu<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == 'w')
      splitRearrange_nvmw<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '1')
      splitRearrange_nvm1<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '2')
      splitRearrange_nvm2<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '3')
      splitRearrange_nvm3<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '4')
      splitRearrange_nvm4<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '5')
      splitRearrange_nvm5<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else if (nvm_opt == '6')
      splitRearrange_nvm6<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);
    else 
      splitRearrange<<<grid,block>>>(numElems, i, dkeys, dkeys_o, dvalues, dvalues_o, dhisto);      
    st_ra.lap_end();
  ...
  st_ssort.print_avg_usec("split_sort", grid);
  /*
  st_l1.print_avg_usec("scan_L1");
  st_inter1.print_avg_usec("scan_inter1");
  st_inter2.print_avg_usec("scan_inter2");
  st_uadd.print_avg_usec("uniforAdd");
  */
  st_ra.print_avg_usec("splitRearrange", grid);
