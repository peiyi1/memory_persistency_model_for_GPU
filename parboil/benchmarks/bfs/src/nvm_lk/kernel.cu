...
__device__ int shadow_prefix_q[SHADOW_SIZE];
__device__ int shadow_next_wf[SHADOW_SIZE];
__device__ int shadow_tail[SHADOW_SIZE];
__device__ int shadow_elems[1024][1024];
__device__ int shadow_sharers[SHADOW_SIZE];
...
#include "nvmx.cu"
  ...
  __device__ unsigned int NVM_last_iter[FLAG_SIZE_1M];
#include "nvms.cu"
#include "nvm3.cu"
#include "nvm4.cu"
//-------------------------------------------------
