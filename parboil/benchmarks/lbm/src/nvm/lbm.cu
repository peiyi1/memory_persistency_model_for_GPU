...
void CUDA_LBM_performStreamCollide( LBM_Grid srcGrid, LBM_Grid dstGrid ) {
	...
	if (nvm_opt == 'a')
	  ...
	  performStreamCollide_kernel_nvmb<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'o')
	  performStreamCollide_kernel_nvmo<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'g')
	  performStreamCollide_kernel_nvmg<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'j')
	  performStreamCollide_kernel_nvmj<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'w')
	  performStreamCollide_kernel_nvmw<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'i')
	  performStreamCollide_kernel_nvmi<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'q')
	  performStreamCollide_kernel_nvmq<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'd')
	  performStreamCollide_kernel_nvmd<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'j')
	  performStreamCollide_kernel_nvmj<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'l')
	  performStreamCollide_kernel_nvml<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == 'u')
	  performStreamCollide_kernel_nvmu<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '1')
	  performStreamCollide_kernel_nvm1<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '2')
	  performStreamCollide_kernel_nvm2<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '3')
	  performStreamCollide_kernel_nvm3<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '4')
	  performStreamCollide_kernel_nvm4<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '5')
	  performStreamCollide_kernel_nvm5<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	else if (nvm_opt == '6')
	  performStreamCollide_kernel_nvm6<<<dimGrid, dimBlock>>>(srcGrid, dstGrid);
	st->lap_end();
	CUDA_ERRCK;
}
